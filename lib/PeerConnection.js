...
class PeerConnection extends NetworkChildClass {
    constructor(params = {}) {
        super(params);

        this._channel = params.ws;
        this._inbound = params.inbound;
        this._peerAddress = params.peerAddress;
        ...
        this.log('info', ''+this, 'Initializing PeerConnection object...');
    ...
    _onMessage(msg) {
        ...
        this.log('info', 'Got message: '+this);
